...
% Par exemple, si je compare M = "abaca" avec un solution S = "abaca", j'obtien la coloration "ggggg". Je regarde combien de mots sont valides
...
% classés pareils pour tous les tours d'un partie.
